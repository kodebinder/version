package com.heap.eg009.findtopKfrequentelementsfromarray;
...
public class HeapApp {
	...
	public static void main(String[] args) {
		...
		System.out.println(HeapApp.topKFrequentlyOccurredNumbersUsingMinHeap(arr, k));

		System.out.println(HeapApp.topKFrequentlyOccurredNumbersUsingMaxHeap(arr, k));
