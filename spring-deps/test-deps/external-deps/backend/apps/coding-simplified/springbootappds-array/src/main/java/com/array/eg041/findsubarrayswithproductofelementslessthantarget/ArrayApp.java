package com.array.eg041.findsubarrayswithproductofelementslessthantarget;
...
public class ArrayApp {
	...
	public static void main(String[] args) {
		...
		System.out.println(ArrayApp.subArrayWithProductMultiplicationLessThanGivenNumber(arr, 10));
	}
