package com.string.eg014.findsmallestsubstringcontainingallcharacterofpattern;
...
public class StringProblems {
	...
	public static void main(String[] args) {
		...
		String pattern = "aabc";
		System.out.println(StringProblems.smallestSubstringWithAllPatternCharcaters(str, pattern));
	}
