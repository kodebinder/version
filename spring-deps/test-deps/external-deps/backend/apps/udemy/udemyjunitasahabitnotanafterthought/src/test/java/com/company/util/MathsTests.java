...
class MathsTests {
    ...
    class SumTests {
        ...
        void sum_Exceptional_LongArray_MathsException() {
            try {
                ...
                assertThrows(MathsException.class, () -> Maths.sum(values));
            } catch (Exception ex) {
                fail();
            }
        }
    ...
    class SubtractTests {
        ...
        public void subtract_Exceptional_LongArray_MathsException() {
            try {
                long[] values = new long[]{Long.MIN_VALUE, Long.MIN_VALUE};
                assertThrows(MathsException.class, () -> Maths.subtract(0, values));
            } catch (Exception ex) {
                fail();
            }
        }
        ...
        public void subtract_Nullable_Null_MathsException() {
            try {
                ...
                assertThrows(MathsException.class, () -> Maths.subtract(10, values));
    ...
    class MultiplyTests {
        ...
        public void multiply_Exceptional_LongArray_MathsException() {
            ...
            try {
                ...
                long[] values = new long[]{Long.MAX_VALUE, Long.MAX_VALUE};
                assertThrows(MathsException.class, () -> Maths.multiply(values));
    ...
    class DivideTests {
        ...
        void divide_Exceptional_DoubleArray_MathsException() {
            ...
            try {
                ...
                assertThrows(MathsException.class, () -> Maths.divide(Double.MAX_VALUE, values));
            } catch (Exception ex) {
                fail();
            }
        }
        ...
        void divide_Nullable_Null_MathsException() {
            ...
            try {
                ...
                double[] values = null;
                assertThrows(MathsException.class, () -> Maths.divide(1, values));
            } catch (Exception ex) {
                fail();
            }
        }
