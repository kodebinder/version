package com.company.dsaeg21.algorithmschapter.DP;
...
public class FloydWarshall {
	...
	public static void main(String[] args) {
		int graph[][] = { { 0, 2, 4, INF, INF, INF, INF }, { 2, 0, 4, 1, INF, INF, INF }, { 4, 4, 0, 2, 8, 4, INF },
				{ INF, 1, 2, 0, 3, INF, 6 }, { INF, INF, 6, 4, 0, 3, 1 }, { INF, INF, 4, INF, 4, 0, 2 },
				{ INF, INF, INF, 4, 2, 3, 0 } };
