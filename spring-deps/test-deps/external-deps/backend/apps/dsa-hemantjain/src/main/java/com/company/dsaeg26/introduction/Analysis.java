package com.company.dsaeg26.introduction;
...
public class Analysis {
	...
	public static void main(String[] args) {
		...
		System.out.println("N = 100, Number of instructions in O(n^2)::" + a.fun4(100));
		System.out.println("N = 100, Number of instructions in O(log(n))::" + a.fun5(100));
		System.out.println("N = 100, Number of instructions in O(log(n))::" + a.fun6(100));
		...
		System.out.println("N = 100, Number of instructions in O(n)::" + a.fun10(100));
		System.out.println("N = 100, Number of instructions in O(n^2)::" + a.fun11(100));
		System.out.println("N = 100, Number of instructions in O(n^3)::" + a.fun12(100));
