...
public class Employee {
    ...
    public static List<Employee> getEmployees() {
        ...
        employees.add(new Employee(144, "Murali Gowda", 28, "Male", 4, "com.company.stringhandling.Product Development", "active", 2014, 32500.0, Collections.singletonList("919826396468")));
        ...
        employees.add(new Employee(188, "Wang Liu", 31, "Male", 4, "com.company.stringhandling.Product Development", "inactive", 2015, 34500.0, Arrays.asList("5656565565", "9090909090")));
        ...
        employees.add(new Employee(222, "Nitin Joshi", 25, "Male", 4, "com.company.stringhandling.Product Development", "active", 2016, 28200.0, Arrays.asList("343435760", "9987767656554545")));
        ...
        employees.add(new Employee(266, "Sanvi Pandey", 26, "Female", 4, "com.company.stringhandling.Product Development", "active", 2015, 28900.0, Arrays.asList("8886798986", "988668987")));
        employees.add(new Employee(277, "Anuj Chettiar", 31, "Male", 4, "com.company.stringhandling.Product Development", "active", 2012, 35700.0, Arrays.asList("78656878676", "895778786778")));
        return employees;
    }
}
